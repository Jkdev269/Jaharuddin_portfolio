export default function Projects({ isDarkMode }) {
  ...
  <path d="M19.4 15C19.6 14.4 19.7 13.7 19.7 13C19.7 12.3 19.6 11.6 19.4 11L21 9.6L19.4 7.6L17.8 8.2C17.3 7.8 16.7 7.5 16 7.3L15.6 5.5H12.4L12 7.3C11.3 7.5 10.7 7.8 10.2 8.2L8.6 7.6L7 9.6L8.6 11C8.4 11.6 8.3 12.3 8.3 13C8.3 13.7 8.4 14.4 8.6 15L7 16.4L8.6 18.4L10.2 17.8C10.7 18.2 11.3 18.5 12 18.7L12.4 20.5H15.6L16 18.7C16.7 18.5 17.3 18.2 17.8 17.8L19.4 18.4L21 16.4L19.4 15Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    ...
    },
    {
      ...
      icon: (
        <svg className="w-10 h-10 text-blue-500" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
  {/* <!-- Chat bubble --> */}
  <path d="M8 12C8 8.68629 10.6863 6 14 6H50C53.3137 6 56 8.68629 56 12V36C56 39.3137 53.3137 42 50 42H28L16 54V42H14C10.6863 42 8 39.3137 8 36V12Z" stroke="currentColor" strokeWidth="4" strokeLinejoin="round" />
  
  {/* <!-- JText lettermark --> */}
  <path d="M22 22H32M32 22V34M32 22H42" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
    ...
    },
    {
      ...
      tags: ["React", "Node.js","Express.js", "MongoDB", "TailwindCSS", "Redux"],
      icon: (
       <svg className="w-10 h-10 text-blue-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M3 3H5L6 14H18L19 6H7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
